...
import { NetworkConfigurationComponent } from 'app/entities/network-configuration/network-configuration.component';
...
describe('Component Tests', () => {
  describe('NetworkConfiguration Management Component', () => {
    let comp: NetworkConfigurationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NetworkConfigurationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new NetworkConfiguration(123)],
            headers
          })
        )
      );
      ...
      expect(comp.networkConfigurations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
