...
import { ProvisionerComponent } from 'app/entities/provisioner/provisioner.component';
...
describe('Component Tests', () => {
  describe('Provisioner Management Component', () => {
    let comp: ProvisionerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProvisionerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.provisioners[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
