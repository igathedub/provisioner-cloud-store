...
import { AppKeyComponent } from 'app/entities/app-key/app-key.component';
import { AppKeyService } from 'app/entities/app-key/app-key.service';
import { AppKey } from 'app/shared/model/app-key.model';

describe('Component Tests', () => {
  describe('AppKey Management Component', () => {
    let comp: AppKeyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AppKeyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.appKeys[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
